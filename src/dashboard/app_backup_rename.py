...
.kpis{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:14px;margin:14px 0 20px}.card{background:#171717;border:1px solid rgba(255,255,255,.08);border-radius:12px;padding:17px 18px;box-shadow:0 1px 3px rgba(0,0,0,.4);min-width:0}.label{font-size:.77rem;color:#a3a3a3;font-weight:700;margin-bottom:7px}.value{font-size:1.65rem;font-weight:800;color:#e5e5e5;white-space:nowrap;overflow:visible}.sub{font-size:.72rem;color:#737373;margin-top:7px;line-height:1.3}
